		...
		<?php 
		require 'header.php';
		require 'includes/acontainer.php';
		$arts = new AContainer;
		$main1 = $arts->getByPosition("main1");
		?>
					...
					<div class="row small-gutters">
						<div class="col-lg-8 top-post-left">
							<div class="feature-image-thumb relative">
								...
								<img class="img-fluid" src=<?php echo '"'.$main1->imagePath.'"' ?> alt="">
							</div>
							<div class="top-post-details">
								<a href=<?php echo '"'.$arts->generateUrl($main1).'"' ?>>
									<h3><?php echo $main1->title; ?></h3>
								</a>
								<ul class="meta">
									<li><a href="#"><span class="lnr lnr-user"></span><?php echo $main1->authorName ?></a></li>
									<li><a href="#"><span class="lnr lnr-calendar-full"></span><?php echo $main1->date ?></a></li>
								</ul>
							</div>
						</div>
