	...
	<?php
		require 'header.php';
		require 'includes/articleManager.php';
		$ac = new ArticleManager($_GET["pid"]);
		?>
						...
						<div class="col-lg-8 post-list">
							...
							<div class="single-post-wrap">
								<div class="content-wrap">
									...
									<a href="#">
										<h3><?php echo $ac->article->title ?></h3>
									</a>
									<ul class="meta pb-20">
										<li><a href="#"><span class="lnr lnr-user"></span><?php echo $ac->article->authorName ?></a></li>
										<li><a href="#"><span class="lnr lnr-calendar-full"></span><?php echo $ac->article->date ?> </a></li>
									</ul>
									<div class="post-container" >
									<?php echo $ac->article->text ?>	
									</div>							
